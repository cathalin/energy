...
// No point putting a class inside a try-catch.
// PHP will throw an error that the class cannot be found anyway.
// Adding try-catch here is superfluous!
...
// echo is slightly quicker than print (~ 100ms)
echo $i->GetImagePathDecayResult;
